        ...
        for name, model in models_to_try.items():
            ...
            try:
                ...
                cv_scores = cross_val_score(
                    model, X_selected, y, cv=tscv, scoring="roc_auc", n_jobs=-1
                )
...
"""
    ...
    def run_full_pipeline(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if self.best_auc < self.min_auc_threshold:
                raise ValueError(
                    f"Failed to achieve AUC ≥ {self.min_auc_threshold}. Best: {self.best_auc:.4f}"
                )
            ...
            self.logger.info(f"✅ Model deployed and ready for production")
