...
class NiceGoldDeployment:
        ...
        default_config = {
            ...
            "git": {
                ...
                "ignore_patterns": [
                    ...
                    ".env.local", "node_modules", ".DS_Store"
                ]
            },
            "backup": {
                "enabled": True,
    ...
    def save_deployment_config(self):
        ...
        try:
            ...
            with open(config_path, 'w', encoding='utf-8') as f:
                yaml.dump(self.deployment_config, f, default_flow_style=False, allow_unicode=True)
    ...
    def check_python_syntax(self) -> bool:
        ...
        self.logger.info(f"✅ Checked {len(python_files)} Python files - no syntax errors")
        return True
...
def main():
    ...
    if args.dry_run:
        ...
        print(json.dumps(deployment.deployment_config, indent=2, ensure_ascii=False))
        return
