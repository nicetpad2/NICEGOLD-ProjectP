    ...
    def _analyze_external_dependencies(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "most_used_dependencies": sorted(
                dep_usage.items(), key=lambda x: x[1], reverse=True
            )[:10],
        }
    ...
    def visualize_dependencies(self, output_path: str = None) -> str:
        ...
        try:
            ...
            nx.draw_networkx_nodes(
                self.dependency_graph, pos, node_color="lightblue", node_size=500
            )

            # Draw edges
            nx.draw_networkx_edges(
                self.dependency_graph, pos, edge_color="gray", arrows=True
            )
