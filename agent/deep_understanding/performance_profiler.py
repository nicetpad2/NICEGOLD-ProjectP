...
class PerformanceProfiler:
    ...
    def _analyze_overall_performance(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "system_memory_total_gb": psutil.virtual_memory().total
            / 1024
            / 1024
            / 1024,
    ...
    def _analyze_cpu_patterns(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "context_switches": getattr(
                    process, "num_ctx_switches", lambda: None
                )(),
                "cpu_optimization_potential": self._assess_cpu_optimization_potential(),
            }

        except Exception as e:
            return {"error": f"CPU analysis failed: {e}", "cpu_efficiency_score": 0.5}
        ...
        try:
            ...
            if io_counters:
                return {
                    ...
                    "io_optimization_recommendations": self._generate_io_recommendations(
                        io_counters
                    ),
                }
            else:
            ...
            return {"error": f"I/O analysis failed: {e}", "io_efficiency_score": 0.5}
                ...
                leaks.append(
                    {
                        ...
                        "growth_rate_mb_per_snapshot": sum(growth_trend)
                        / len(growth_trend),
                    }
                )
        ...
        try:
            if io_counters.write_count > io_counters.read_count * 2:
                recommendations.append(
                    "Consider reducing write operations or batching writes"
                )

            if io_counters.read_bytes > 1024 * 1024 * 1024:  # > 1GB
                recommendations.append(
                    "Large amount of data read - consider streaming or chunking"
                )

            if io_counters.write_bytes > 1024 * 1024 * 1024:  # > 1GB
                recommendations.append(
                    "Large amount of data written - consider compression"
                )
    ...
    def _calculate_overall_performance_score(self) -> float:
        ...
        try:
            ...
            # Weight the scores
            overall_score = (
                memory_score * 0.4 + cpu_score * 0.4 + 0.6 * 0.2
            )  # Base score
