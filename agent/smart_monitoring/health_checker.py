...
class HealthChecker:
    ...
    def _check_file_system(self) -> Dict[str, Any]:
        ...
        try:
            ...
            accessible = os.path.exists(self.project_root) and os.access(self.project_root, os.R_OK)
    ...
    def _check_project_structure(self) -> Dict[str, Any]:
        ...
        status = 'healthy' if not missing_files else 'warning' if len(missing_files) < len(required_files) else 'unhealthy'
    ...
    def _check_dependencies(self) -> Dict[str, Any]:
        ...
        try:
            ...
            status = 'healthy' if not missing_modules else 'warning' if len(missing_modules) < len(essential_modules) else 'unhealthy'
            
            return {
                'status': status,
                'available': available_modules,
                'missing': missing_modules,
                'issues': [f'Missing modules: {missing_modules}'] if missing_modules else []
            }
        except Exception as e:
            return {
                'status': 'error',
    ...
    def get_health_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'healthy_components': sum(1 for check in checks.values() if check.get('status') == 'healthy')
        }
